...
import "./BeforeFood.css";

export const BeforeFood = () => {
  ...
  return (
    <div id="food_container">
      ...
      <div
        id={
          data.length !== 0 ? "food_search_data_div" : "no_food_search_data_div"
        }
      >
        {data.map((e, i) => (
            ...
            <div className="food_search_result_div_sec_1">
              ...
              <div>
                ...
                <div>
                  ...
                  <li>
                    Protein : {Math.floor(data[i].recipe.digest[2].total)} mg
                  </li>
                </div>
              </div>
            </div>
            <div className="calories_circle">
              {" "}
              {Math.floor(data[i].recipe.calories)}{" "}
            </div>
          </div>
        ))}
      </div>
